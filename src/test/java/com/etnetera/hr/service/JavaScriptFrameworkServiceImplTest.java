...
public class JavaScriptFrameworkServiceImplTest {
    ...
    void update_OK() {
        // given
        JavaScriptFrameworkPlainRequest request = getJavaScriptFrameworkPlainRequestBuilder()
                .hypeLevel(4)
                .build();
        ...
        // when
        var response = javaScriptFrameworkService.update(request);
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(response.getVersions().get(0).getHypeLevel()).isEqualTo(4);
        });
    ...
    void update_NotFound() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> {
            javaScriptFrameworkService.update(request);
        });
    ...
    public void update_NotValidName(String name) {
        var requestData = getJavaScriptFrameworkPlainRequestBuilder()
                .name(name)
                .build();

        assertThrows(ConstraintViolationException.class, () -> {
            javaScriptFrameworkService.update(requestData);
        });
    }

    @ParameterizedTest
    @ValueSource(strings = {"56", "xxx", "1.0", "1..0", "best version"})
    public void update_NotValidVersion(String version) {
        var requestData = getJavaScriptFrameworkPlainRequestBuilder()
                .version(version)
                .build();
    ...
    @Test
    public void update_NotValidDeprecationDate() {
        var requestData = getJavaScriptFrameworkPlainRequestBuilder()
    ...
    public void update_NotValidHypeLevel(int hypeLevel) {
        var requestData = getJavaScriptFrameworkPlainRequestBuilder()
                .hypeLevel(hypeLevel)
                .build();
    ...
    void create_OK_foundByName() {
        ...
        when(javaScriptFrameworkRepository.findByName(request.getName())).thenReturn(Optional.of(javaScriptFrameworkVersion.getFramework()));
